						...
						<p>
							...
							<span class="pull-right"> 
								<s:if test="decodifica.uid == null">
									<!-- SIAC-8699 -->
									<s:submit cssClass="btn btn-primary" action="messaggioInformativo_create" value="inserisci decodifica" />
								</s:if> 
								<s:else>
									<!-- SIAC-8699 -->
									<s:submit cssClass="btn btn-primary" action="messaggioInformativo_update" value="aggiorna" />
								</s:else>
							</span>
