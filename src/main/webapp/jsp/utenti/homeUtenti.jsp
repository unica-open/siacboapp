					...
					<div class="content-backoffice">
						...
						<div class="content-user">
							...
							<ul class="titles-container margin-large">
								...
								<li><a href="gruppo/elencoGruppi.do" class="title-btn"><i
										class="icon-group gest-gruppi"></i><span>gestione
											gruppi</span></a></li>
						...
						<div class="content-table">
							<ul class="titles-container margin-large">
								...
								<li><a href="decodifica/elencoDecodifiche.do"
									class="title-btn"><i class="icon-code gestDecod"></i><span>gestione
											decodifiche</span></a></li>

								<li><a href="decodifica/messaggioInformativo.do"
									class="title-btn"><span>modifica messaggio informativo</span></a></li>
							</ul>
						</div>
					</div>
