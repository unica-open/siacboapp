	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
		        ...
		        <li class="active">Gestione soggetti</li>
...
<h4 class="titleBO"><i class="icon-user"></i>Gestione soggetti</h4>
...
<table class="table tab_left"> 
	<tbody>
	<s:iterator value="elencoSoggetti">
	<tr>
	<td  id="descrizione" class="descrizione"><i class="icon-angle-right"></i><a  class="marginLeft2" href="<s:url 
				action="soggetto"><s:param name="uid" >
					<s:property value="uid" /></s:param>
		</s:url>"><s:property value="%{codice + ' - ' + codiceFiscale + ' - ' + descrizione}" /></a></td>

			
		<td class="elimina tab_Right">	<a  class="btn" onclick="return confirm('Eliminare <s:property value="%{codice + ' - ' + codiceFiscale + ' - ' + descrizione}" />?')" href="<s:url 
					action="eliminaSoggetto"><s:param name="uid" >
						<s:property value="uid" /></s:param>
...
<a class="btn btn-primary" href="<s:url 
				action="soggetto"/>">inserisci soggetto</a>					</span>
