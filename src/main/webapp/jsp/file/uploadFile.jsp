...
<s:form cssClass="form-horizontal" action="uploadFile" method="post" enctype="multipart/form-data">
      ...
      />
          ...
          <p class="margin-medium">
			  ...
			  <!-- SIAC-8699 -->
			  <s:submit cssClass="btn btn-primary pull-right"  action="uploadFile_upload"  value="invia" />
		  </p>
	...
	<script type="text/javascript" src="${jspath}file/uploadFile.js" charset="utf-8"></script>
