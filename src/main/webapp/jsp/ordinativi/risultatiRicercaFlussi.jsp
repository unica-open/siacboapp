	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li><a href="ricercaFlussi.do">Ricerca distinte</a>
					<span class="divider">&gt;</span></li>
...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="span12 contentPage">    
		...
		<s:form action="risultatiRicercaFlussi" method="post" id="form">

			<s:hidden name="codiceTipoFlussi" id="codiceTipoFlussi" />
			<s:hidden name="anno" id="codiceTipoFlussi" />
		...
		<s:if test="not elencoFlussi.empty">	        
			<fieldset class="form-horizontal">

			<h4><span class="num_result"><s:property value="elencoFlussi.size()"/></span> 
			distint<s:if test="elencoFlussi.size() == 1">a</s:if><s:else>e</s:else></h4>                 
			...
			<div id="simple-pagination">
				...
				<table class="table table-hover tab_left"  summary="...." >
					...
					<s:iterator value="elencoFlussi" status="st" var="ord">
		<tr>
...
<!-- 									</div> -->
						...
						<button  class="btn modalConsultaButton" data-toggle="modal" data-target="#modalConsulta"  
							data-uid-flusso="<s:property value="#ord.uid" />"
							data-ord-anno="<s:property value="#ord.anno" />"
							data-numero-flusso="<s:property value="#ord.numero" />"
						>consulta</button>
...
<%-- 		<s:url  --%>
<%-- 								action="consultaFlusso"><s:param name="uid" > --%>
...
<%-- 						</s:url> --%>
	...
	<div class="simple-pagination-navigation">
		...
		<a class="btn btn-secondary" href="ricercaFlussi.do">indietro</a>   
	</p> 
  ...
  <div class="modal-dialog" role="document">
	...
	<%-- <s:include value="/jsp/gestionOrdinativi/consultaFlusso.jsp" /> --%>
	
	<div class="modal-footer">
		<button class="btn btn-secondary" data-dismiss="modal" >indietro</button>     
	</div>
...
<%-- <r:include url="/ris/servizi/siac/include/myCheckbox.html" resourceProvider="rp"/> --%>
   ...
   <s:include value="/jsp/include/jquery.simple.pagination.jsp" />
	...
	<script type="text/javascript" src="${jspath}ordinativi/risultatiRicercaFlussi.js" charset="utf-8"></script>
