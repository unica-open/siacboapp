...
<!-- 				</div>  -->
          ...
          <p class="margin-medium">
			...
			<s:submit cssClass="btn btn-primary pull-right" method="preparaVB"  value="prepara vb" />
			<s:if test="siopePlus">
				<s:submit cssClass="btn btn-primary pull-right" method="trasmettiSiopePlus"  value="trasmetti siope plus" />
			</s:if><s:else>
				<s:submit cssClass="btn btn-primary pull-right" method="trasmetti"  value="trasmetti" />
			</s:else>
			<s:if test="siopePlus">
				<s:submit cssClass="btn btn-primary pull-right" method="sbloccaSiopePlus"  value="sblocca" />
			</s:if><s:else>
				<s:submit cssClass="btn btn-primary pull-right" method="sblocca"  value="sblocca" />
			</s:else>			


			<s:submit cssClass="btn btn-primary pull-right" id="disattivaTrasmissione" method="disattivaTrasmissione"  value="disattiva trasmissione" />
			<s:submit cssClass="btn btn-primary pull-right" id="attivaTrasmissione" method="attivaTrasmissione"  value="attiva trasmissione" />

			<s:submit cssClass="btn btn-primary pull-right" id="associaProvvisoriCassa" method="associaProvvisoriCassa"  value="associa provvisorio di cassa" />
...
<script src="${jspath}gestioneOrdinativi/gestioneOrdinativi.js"></script>
