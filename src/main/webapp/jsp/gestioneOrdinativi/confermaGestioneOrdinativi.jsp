			  ...
			  <a class="btn btn-secondary" href="gestioneOrdinativi.do">indietro</a>   
			  	...
			  	<s:if test="not elencoOrdinativi.empty">	        
				  	...
				  	<s:if test="mostraPulsanteApriModaleProvvisorioCassa">	        
						<s:submit cssClass="nascosto btn btn-primary pull-right" method="conferma" id="conferma"  value="conferma" />
					...
					<s:else>
						  <s:submit cssClass="btn btn-primary pull-right" method="conferma" id="conferma"  value="conferma" />
					</s:else>
				</s:if>
		  </p> 
...
<script type="text/javascript" src="${jspath}gestioneOrdinativi/confermaGestioneOrdinativi.js" charset="utf-8"></script>
