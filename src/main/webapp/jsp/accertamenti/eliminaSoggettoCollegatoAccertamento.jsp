	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
		        ...
		        <li class="active">Elimina soggetto collegato all'accertamento</li>
			</ul>
		</div>
	</div>
...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="span12 contentPage">       
        ...
        <s:form action="eliminaSoggettoCollegatoAccertamento" method="post" cssClass="form-horizontal" id="form">
...
<s:if test="hasActionMessages()">
			...
			<h3>Elimina soggetto collegato all'accertamento</h3>
			...
			<!-- SIAC-8699 -->
			<s:submit cssClass="btn btn-primary pull-right" action="eliminaSoggettoCollegatoAccertamento_cerca" id="cerca" value="cerca"  />
...
<br/><br/><div class="step-content"><div class="step-pane"><h4></h4></div></div>
		...
		<ul class="htmlelt step-content">
			<li>
				<dfn>Anno</dfn>
				<dl><s:property value="accertamento.anno"/>&nbsp;</dl>
			</li>
			<li>
				<dfn>Numero</dfn>
				<dl><s:property value="accertamento.numero"/>&nbsp;</dl>
			</li>
		</ul>
...
<div class="control-group">
		    ...
		    <div class="controls">      
		          					<s:hidden id="idSoggetto" cssClass="codiceSoggetto" name="accertamento.soggetto.uid" />
		          
 <s:textfield readonly="true" id="codiceSoggetto" name="accertamento.soggetto.codice" cssClass="codiceSoggetto lbTextSmall span2 soloNumeri"  />
...
<div class="control-group">
		    ...
		    <div class="controls">   
								<s:select  cssClass="span6 chosen-select" size="3" id="classeSoggetto"
									name="accertamento.classeSoggetto.uid" headerKey="" headerValue=""
		...
		<div class="controls">
			...
			<!-- SIAC-8699 -->
			<s:submit cssClass="btn btn-primary pull-right" action="eliminaSoggettoCollegatoAccertamento_aggiornaSoggettoCollegato"  value="aggiorna" />
...
<script src="${jspath}accertamenti/eliminaSoggettoCollegatoAccertamento.js"></script>
