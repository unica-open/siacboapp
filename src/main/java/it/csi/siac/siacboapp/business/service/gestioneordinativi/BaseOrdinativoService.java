...
public abstract class BaseOrdinativoService extends BoService {
	...
	public List<SiacTOrdinativoWrapper> ricercaOrdinativi(int idEnte, CriteriRicercaOrdinativi criteri, EntityWrapperMapping... entityWrapperMappings) {
		 return ordinativoDad.ricercaOrdinativi(idEnte, criteri, entityWrapperMappings);
	}
	...
	public List<SiacTOrdinativo> ricercaOrdinativiDaFlusso(Integer uid, String codiceTipoOrdinativi) {
		return siacTOrdinativoDao.ricercaOrdinativiDaFlusso(uid, codiceTipoOrdinativi);
	}
