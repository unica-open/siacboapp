...
import it.csi.siac.siacboapp.frontend.ui.model.ordinativi.GestioneOrdinativiModel;
...
public class GestioneOrdinativiAction extends GenericOrdinativoAction<GestioneOrdinativiModel> {
	...
	protected void setElencoCodiciFlussoOrdinativi(int idEnte, int idBilancio) {
	...
	protected void setElencoCodiciDistintaOrdinativi(int idEnte) {
	...
	public void validateAssociaProvvisoriCassa() throws IOException {
		if (!isAzioneConsentita(AzioneConsentitaEnum.ASSOCIA_PROVVISORI_CASSA)) {
