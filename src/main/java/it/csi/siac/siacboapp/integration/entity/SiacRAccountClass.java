...
public class SiacRAccountClass extends SiacTEnteBase {
	...
	private SiacTClass strutturaAmministrativaContabile;

	public SiacRAccountClass(SiacTClass strutturaAmministrativaContabile) {
		this();
		this.strutturaAmministrativaContabile = strutturaAmministrativaContabile;
	}
	...
	public SiacTClass getStrutturaAmministrativaContabile() {
		return strutturaAmministrativaContabile;
	}

	public void setStrutturaAmministrativaContabile(SiacTClass strutturaAmministrativaContabile) {
		this.strutturaAmministrativaContabile = strutturaAmministrativaContabile;
	}
