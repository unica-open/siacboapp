...
@Component
public class SiacTMovgestFlagSoggettoDurcMapper extends BaseEntityWrapperMapper<SiacTMovgest, SiacTMovgestWrapper> {

	@Override
	public void map(SiacTMovgest o, SiacTMovgestWrapper ow) {
		try {
			ow.setFlagSoggettoDurc(o.getFlagSoggettoDurc());
		}
