...
public class SiacDDocFamTipo extends SiacTEnteBase {
	...
	private static final long serialVersionUID = 7080754999671207039L;
	...
	@OneToMany(mappedBy="tipoFamigliaDocumenti")
	private Set<SiacDDocTipo> tipiDocumento;


	public Set<SiacDDocTipo> getTipiDocumento() {
		return tipiDocumento;
	}

	public void setTipiDocumento(Set<SiacDDocTipo> tipiDocumento) {
