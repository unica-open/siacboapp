...
@Component
public class SiacTMovgestClasseSoggettoMapper extends BaseEntityWrapperMapper<SiacTMovgest, SiacTMovgestWrapper> {

	@Override
	public void map(SiacTMovgest o, SiacTMovgestWrapper ow) {
		try {
			ow.setClasseSoggetto(o.getClasseSoggetto());
		}
